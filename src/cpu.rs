...
impl CPU{
    ...
    pub fn step(&mut self){
        ...
        match opcode {
            ...
            0x3F => self.ccf(opcode, pc),
            0x40 ... 0x45 => self.ld_r_r(opcode, pc),
            0x46 => self.ld_r_mem_hl(opcode, pc),
            0x47 ... 0x4D => self.ld_r_r(opcode, pc),
            0x4E => self.ld_r_mem_hl(opcode, pc),
            0x4F ... 0x55 => self.ld_r_r(opcode, pc),
            0x56 => self.ld_r_mem_hl(opcode, pc),
            0x57 ... 0x5D => self.ld_r_r(opcode, pc),
            0x5E => self.ld_r_mem_hl(opcode, pc),
            0x5F ... 0x65 => self.ld_r_r(opcode, pc),
            0x66 => self.ld_r_mem_hl(opcode, pc),
            0x67 ... 0x6D => self.ld_r_r(opcode, pc),
            0x6E => self.ld_r_mem_hl(opcode, pc),
            0x6F => self.ld_r_r(opcode, pc),
            0x70 ... 0x75 => self.ld_mem_hl_r(opcode, pc),
            0x76 => self.halt(opcode, pc),
            0x77 => self.ld_mem_hl_r(opcode, pc),
            0x78 ... 0x7D => self.ld_r_r(opcode, pc),
            ...
            0xD3 => panic!("0xD3 is unsupported"),
            ...
            0xDB => panic!("0xDB is unsupported"),
            0xDC => self.call_cc_nn(opcode, pc),
            0xDD => panic!("0xDD is unsupported"),
            ...
            0xE3 => panic!("0xE3 is unsupported"),
            0xE4 => panic!("0xE4 is unsupported"),
            ...
            0xEB => panic!("0xEB is unsupported"),
            0xEC => panic!("0xEC is unsupported"),
            0xED => panic!("0xED is unsupported"),
            ...
            0xFC => panic!("0xFC is unsupported"),
            0xFD => panic!("0xFD is unsupported"),
