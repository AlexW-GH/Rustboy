...
impl CPU{
    ...
    pub fn step(&mut self){
        ...
        match opcode {
            ...
            0x03 => self.inc_ss(opcode, pc),
            0x04 => self.inc_r(opcode, pc),
            ...
            0x24 => self.inc_r(opcode, pc),
            0x25 => self.dec_r(opcode, pc),
            ...
            0x3D => self.dec_r(opcode, pc),
            0x40 => self.ld_r_r(opcode, pc),
            0x41 => self.ld_r_r(opcode, pc),
            0x42 => self.ld_r_r(opcode, pc),
            0x43 => self.ld_r_r(opcode, pc),
            0x44 => self.ld_r_r(opcode, pc),
            0x45 => self.ld_r_r(opcode, pc),
            0x46 => self.ld_r_mem_hl(opcode, pc),
            0x47 => self.ld_r_r(opcode, pc),
            0x48 => self.ld_r_r(opcode, pc),
            0x49 => self.ld_r_r(opcode, pc),
            0x4A => self.ld_r_r(opcode, pc),
            0x4B => self.ld_r_r(opcode, pc),
            0x4C => self.ld_r_r(opcode, pc),
            0x4D => self.ld_r_r(opcode, pc),
            0x4E => self.ld_r_mem_hl(opcode, pc),
            0x4F => self.ld_r_r(opcode, pc),
            0x50 => self.ld_r_r(opcode, pc),
            0x51 => self.ld_r_r(opcode, pc),
            0x52 => self.ld_r_r(opcode, pc),
            0x53 => self.ld_r_r(opcode, pc),
            0x54 => self.ld_r_r(opcode, pc),
            0x55 => self.ld_r_r(opcode, pc),
            0x56 => self.ld_r_mem_hl(opcode, pc),
            0x57 => self.ld_r_r(opcode, pc),
            0x58 => self.ld_r_r(opcode, pc),
            0x59 => self.ld_r_r(opcode, pc),
            0x5A => self.ld_r_r(opcode, pc),
            0x5B => self.ld_r_r(opcode, pc),
            0x5C => self.ld_r_r(opcode, pc),
            0x5D => self.ld_r_r(opcode, pc),
            0x5E => self.ld_r_mem_hl(opcode, pc),
            0x5F => self.ld_r_r(opcode, pc),
            0x60 => self.ld_r_r(opcode, pc),
            0x61 => self.ld_r_r(opcode, pc),
            0x62 => self.ld_r_r(opcode, pc),
            0x63 => self.ld_r_r(opcode, pc),
            0x64 => self.ld_r_r(opcode, pc),
            0x65 => self.ld_r_r(opcode, pc),
            0x66 => self.ld_r_mem_hl(opcode, pc),
            0x67 => self.ld_r_r(opcode, pc),
            0x68 => self.ld_r_r(opcode, pc),
            0x69 => self.ld_r_r(opcode, pc),
            0x6A => self.ld_r_r(opcode, pc),
            0x6B => self.ld_r_r(opcode, pc),
            0x6C => self.ld_r_r(opcode, pc),
            0x6D => self.ld_r_r(opcode, pc),
            0x6E => self.ld_r_mem_hl(opcode, pc),
            0x6F => self.ld_r_r(opcode, pc),
            0x70 => self.ld_mem_hl_r(opcode, pc),
            0x71 => self.ld_mem_hl_r(opcode, pc),
            0x72 => self.ld_mem_hl_r(opcode, pc),
            0x73 => self.ld_mem_hl_r(opcode, pc),
            0x74 => self.ld_mem_hl_r(opcode, pc),
            0x75 => self.ld_mem_hl_r(opcode, pc),
            0x77 => self.ld_mem_hl_r(opcode, pc),
            0x78 => self.ld_r_r(opcode, pc),
            0x79 => self.ld_r_r(opcode, pc),
            0x7A => self.ld_r_r(opcode, pc),
            0x7B => self.ld_r_r(opcode, pc),
            0x7C => self.ld_r_r(opcode, pc),
            0x7D => self.ld_r_r(opcode, pc),
            0x7E => self.ld_r_mem_hl(opcode, pc),
            0x7F => self.ld_r_r(opcode, pc),
